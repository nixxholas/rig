...
export function getWorkletTool(feature: WorkletsFeature, agentId: string) {
    return defineAgentTool({
        ...
        ) => await feature.getPage(ctx, agentId, name, query as WorkletDetailQuery),
        toLLM: (page) => [
            {
                type: "text",
                text: feature.formatDetailPageForModel(page),
            },
        ],
    });
}