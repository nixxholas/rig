 ...
 * whatever stable identity namespace they prefer; these bounds merely keep receipts and model
 * output finite.
 */
export const MAX_SCHEDULING_TIMESTAMP = 8_640_000_000_000_000;
export const MAX_SCHEDULING_ID_LENGTH = 128;
export const MAX_SCHEDULING_OPERATION_ID_LENGTH = 128;
...
export const MAX_SCHEDULING_FINGERPRINT_LENGTH = 65_536;
...
export const schedulingOperationIdSchema = Type.String({
    minLength: 1,
    maxLength: MAX_SCHEDULING_OPERATION_ID_LENGTH,
    pattern: identityPattern,
});
...
export const schedulingFingerprintSchema = Type.String({
    minLength: 1,
    maxLength: MAX_SCHEDULING_FINGERPRINT_LENGTH,
});
...
const waitInputIdentity = {
    operationId: Type.Optional(schedulingOperationIdSchema),
...
/** Model schemas omit operation and record identities, which are feature-owned. */
export const schedulingWaitToolInputSchema = Type.Omit(schedulingWaitInputSchema, [
    "operationId",
    "id",
]);
export const schedulingWaitUntilToolInputSchema = Type.Omit(schedulingWaitUntilInputSchema, [
    "operationId",
    "id",
]);
...
/** Model-facing scheduling never exposes a target or either durable identity. */
...
export const schedulingCancelToolInputSchema = Type.Omit(schedulingCancelInputSchema, [
    "operationId",
]);
...
/** The scheduler-facing delivery request carries the operation id and fingerprint as well. */
export const schedulingDeliveryOutcomeRequestSchema = Type.Union([
    Type.Object(
        {
            ...schedulingDeliveredOutcomeFields,
            operationId: schedulingOperationIdSchema,
            fingerprint: schedulingFingerprintSchema,
        },
        { additionalProperties: false },
    ...
    Type.Object(
        {
            ...schedulingUndeliveredOutcomeFields,
            operationId: schedulingOperationIdSchema,
            fingerprint: schedulingFingerprintSchema,
        },
        { additionalProperties: false },
...
export type SchedulingOperationId = Static<typeof schedulingOperationIdSchema>;
export type SchedulingEventId = Static<typeof schedulingEventIdSchema>;
export type SchedulingFingerprint = Static<typeof schedulingFingerprintSchema>;
