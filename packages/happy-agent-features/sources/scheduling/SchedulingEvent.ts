 ...
 * that outcome through the feature's structural delivery operation, which gives observers one
...
export const schedulingFeatureListenerSchema = Type.Object(
    {
...
export type SchedulingFeatureListener = Static<typeof schedulingFeatureListenerSchema>;