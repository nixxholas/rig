 ...
 *
 * Kept locally because profile media is owned by this module and the package has no ThumbHash
 * runtime dependency. The wire format follows the canonical reference encoder.
 */
