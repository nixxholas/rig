...
selection, daemon settings, and permission mode) are filtered before merging.
Precedence is global → project → runtime.
...
providers, MCP servers, Docker, network, permissions, P2P, presence, theme,
features, workspace sync/protection, and retention settings.
