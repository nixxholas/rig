...
/**
 * The generated image or audio inside one interaction response, with whatever Gemini wrote about
 * it. A response with no media, or with media that decodes to nothing, is a failed generation
