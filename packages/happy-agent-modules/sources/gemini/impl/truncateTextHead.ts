/**
 * Keep the beginning of a piece of text, within both a byte and a line bound.
 *
 * Gemini writes an image description or a set of lyrics alongside the media it generates, and an
 * analysis can run to any length. What it says first is what matters, so the head is kept, cut on
 * a line boundary where possible and never in the middle of a UTF-8 sequence.
 */
