...
/**
 * A persisted presence value. The module database resolves `effectiveFrom`, `expiresAt`, `fallback`,
 * and recurring schedules when it reads this value at a supplied clock instant. The module does
