 ...
 * its model-facing rendering must remain bounded even when the module database is large
...
const openAppletActionSchema = Type.Object(
    {
        ...
        /** An opaque applet identity. The module never imports or resolves Applet data. */
...
/** The fixed slot/scope compatibility matrix owned by the module's type contract. */
