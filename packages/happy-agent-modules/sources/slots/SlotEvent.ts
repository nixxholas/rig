...
const slotModuleListenerShapeSchema = Type.Object(
    {
...
export const slotModuleListenerSchema = slotModuleListenerShapeSchema;
export type SlotModuleListener = Static<typeof slotModuleListenerSchema>;
