...
/**
 * A bounded source query. The five closed variants are shared by the public module input, list
 * tool, and module database contract. Cursors are exact bounded offsets, so a page's next cursor must
