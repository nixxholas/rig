...
export const terminalScopeSchema = Type.Object(
    {
        ...
        workspaceId: Type.Optional(Type.String({ minLength: 1, maxLength: MAX_TERMINAL_ID_LENGTH })),
    },
    exact,
);
...
export const createTerminalInputSchema = Type.Object(
    {
        ...
        maxScrollback: Type.Optional(Type.Integer({ minimum: 0, maximum: MAX_TERMINAL_SCROLLBACK })),
