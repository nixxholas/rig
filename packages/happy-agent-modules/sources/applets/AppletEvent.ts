...
/** Stable module events delivered both transactionally and after the outermost commit. */
...
export const appletModuleListenerSchema = Type.Object(
    {
...
export type AppletModuleListener = Static<typeof appletModuleListenerSchema>;
