...
export function externalToolCallSave(tx: TX, call: ExternalToolCall): void {
    tx.insert(externalToolCalls)
        .values({
            ...
            resolutionJson: call.resolution === undefined ? null : JSON.stringify(call.resolution),
