...
/** What Rig knows before it reads the catalog: a model, and whatever else the person named. */
 ...
 * the effort or the service tier is refused. Rig therefore resolves its own defaults here, once,
...
export function resolveSessionSelection(
    ...
    if (providers.length === 0) {
        throw new RigUserError(`Model "${preferences.modelId}" is not available on this agent.`, {
