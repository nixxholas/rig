...
/**
 * The configuration a receiving Rig needs to build a provider after the optional credential
...
/**
 * A credential snapshot encrypted by the sender's P2P identity for the receiving Rig.
 */
