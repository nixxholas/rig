...
export const webappUpdateTool = defineTool({
    ...
    label: "Update webapp",
    description:
        "Import a new version of an existing webapp from a source folder inside the active workspace or Rig-generated media directory. The import becomes the next version (v2, v3, ...) and is made current; earlier versions are kept. A description of the change is required.",
