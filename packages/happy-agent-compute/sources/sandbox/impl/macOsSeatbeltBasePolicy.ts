// Adapted from OpenAI Codex's macOS Seatbelt base policy for this compute sandbox.
// Licensed under the Apache License, Version 2.0. See LICENSE-CODEX.
export const MACOS_SEATBELT_BASE_POLICY = String.raw`(version 1)
...
(allow sysctl-read
  ...
  ; but mostly for fingerprinting concerns which are not relevant to this sandbox.
