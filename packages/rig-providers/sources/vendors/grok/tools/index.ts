...
import { server_web_search } from "@/vendors/grok/tools/server_web_search.js";
import { server_x_search } from "@/vendors/grok/tools/server_x_search.js";
 ...
 */
export const grok_server_tools: readonly SessionTool[] = [server_web_search, server_x_search];
