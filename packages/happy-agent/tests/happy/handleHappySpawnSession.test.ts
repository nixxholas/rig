...
import type { HappyModel, HappySpawnRequest } from "../../sources/modules/happy/index.js";
...
describe("the session id one spawn request resolves to", () => {
    ...
    it("is a name the conversation catalog accepts", () => {
        expect(createHappySpawnSessionId("machine-1", "phone-1")).toMatch(/^[a-z0-9][a-z0-9_-]*$/);
    });
});
