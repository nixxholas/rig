...
This directory is the filesystem-facing Git layer for the v2 Happy agent host. It owns Git command
...
tracking. It has no database, protocol, project-catalog, or HTTP coupling.
