...
import {
    happyAgentEventSchema,
    type AppendHappyAgentEvent,
    type HappyAgentEvent,
} from "./EventsModule.js";
...
function eventFromRow(input: unknown): HappyAgentEvent {
...
export function validateAppendEvent(input: AppendHappyAgentEvent): void {
